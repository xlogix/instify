...
public class ListAdapterExpandableAdapter extends BaseExpandableListAdapter {
    ...
    public ListAdapterExpandableAdapter(Context context, ArrayList<String> headerArray,
