...
public class TimeTableFragment extends Fragment implements WeekView.EventClickListener, MonthLoader.MonthChangeListener, WeekView.EventLongPressListener, WeekView.EmptyViewLongPressListener {
    ...
    public List<? extends WeekViewEvent> onMonthChange(int newYear, int newMonth) {
        ...
        WeekViewEvent event = new WeekViewEvent(1, "Submission of Chemistry Record", startTime, endTime);
        ...
        endTime.set(Calendar.MONTH, newMonth - 1);
        event = new WeekViewEvent(10, "Surprise Test", startTime, endTime);
        ...
        event = new WeekViewEvent(10, "Soft Skills Assignment Submission", startTime, endTime);
        ...
        endTime.set(Calendar.MONTH, newMonth - 1);
        event = new WeekViewEvent(2, "Project Day", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_02));
        events.add(event);
        ...
        endTime.set(Calendar.MONTH, newMonth - 1);
        event = new WeekViewEvent(3, "Class Test", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_03));
        events.add(event);
        ...
        endTime = (Calendar) startTime.clone();
        endTime.add(Calendar.HOUR_OF_DAY, 3);
        event = new WeekViewEvent(5, "Any other event here", startTime, endTime);
        event.setColor(getResources().getColor(R.color.event_color_01));
        events.add(event);
