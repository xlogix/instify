...
public class MyFirebaseDownloadService extends MyFirebaseBaseTaskService {
  ...
  private void downloadFromPath(final String downloadPath) {
    Timber.d(downloadPath, "downloadFromPath:");
    ...
    mStorageRef.child(downloadPath).getStream(new StreamDownloadTask.StreamProcessor() {
      @Override public void doInBackground(StreamDownloadTask.TaskSnapshot taskSnapshot,
        ...
        while ((size = inputStream.read(buffer)) != -1) {
          ...
          showProgressNotification(getString(R.string.progress_downloading), bytesDownloaded,
              totalBytes);
        }
      ...
      @Override public void onSuccess(StreamDownloadTask.TaskSnapshot taskSnapshot) {
      ...
      @Override public void onFailure(@NonNull Exception exception) {
        Timber.w(exception, "download:FAILURE");
