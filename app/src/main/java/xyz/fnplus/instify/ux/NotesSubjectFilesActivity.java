...
import xyz.fnplus.instify.models.NotesFileModel;
import xyz.fnplus.instify.ux.adapters.ListExpandableAdapter;
import xyz.fnplus.instify.ux.adapters.NotesFileAdapter;
...
//                        String errorMsg = user.getString("error_msg");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchManager = (SearchManager) NotesSubjectFilesActivity.this.getSystemService(Context.SEARCH_SERVICE);
        if (searchItem != null) {
            searchView = (SearchView) searchItem.getActionView();
        }
        if (searchView != null) {
            searchView.setSearchableInfo(searchManager.getSearchableInfo(NotesSubjectFilesActivity.this.getComponentName()));
