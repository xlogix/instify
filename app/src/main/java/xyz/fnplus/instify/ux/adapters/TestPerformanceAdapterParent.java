...
import xyz.fnplus.instify.models.SubjectsModel;
import xyz.fnplus.instify.models.TestPerformanceModel;

public class TestPerformanceAdapterParent extends RecyclerView.Adapter<TestPerformanceAdapterParent.ViewHolder> {
...
//        manager.setOrientation(LinearLayoutManager.VERTICAL);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        TextView mTesttype;
        @BindView(R.id.toprecyc)
        RecyclerView mToprecyc;
